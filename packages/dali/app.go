...
import (
     ...
     "fmt"
     "strconv"
     "github.marqeta.com/marqeta/dali/models"
     "database/sql"
     _ "github.com/lib/pq"
...
func (a *App) Run(addr string) {
    fmt.Println ("Server running and listening on port: " + addr)
...
func (a *App) initializeRoutes() {
	...
	a.Router.HandleFunc("/business/{token:.*}", a.getBusiness).Methods("GET")
}

func (a *App) ping(w http.ResponseWriter, r *http.Request) {
	respondWithJSON(w, http.StatusOK, map[string]string{"result": "success", "version": VERSION})
}
